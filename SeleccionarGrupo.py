...
PriTri_boton=Button(AgreGrupo,text="1er trimestre", bg="orangered",fg="white")
PriTri_boton.grid(column=1,row=2,padx=10,pady=10)

SegTri_boton=Button(AgreGrupo,text="2do trimestre",bg="orangered",fg="white")
SegTri_boton.grid(column=2,row=2,padx=10,pady=10)

TerTri_boton=Button(AgreGrupo,text="3er trimestre",bg="orangered",fg="white")
TerTri_boton.grid(column=3,row=2,padx=10,pady=10)

Prom_boton=Button(AgreGrupo,text="Promedio del ciclo escolar",bg="orangered",fg="white")
Prom_boton.grid(column=0,row=3,columnspan=5, padx=(50,10),pady=10)

Reg_boton=Button(AgreGrupo,text="Regresar",bg="orangered",fg="white")
